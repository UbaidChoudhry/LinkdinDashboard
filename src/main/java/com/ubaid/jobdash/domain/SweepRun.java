 ...
 * added by {@code V8__run_sources.sql} and the detail counters from {@code V10__detail_progress.sql}.
 *
 ...
 * @param detailsDone    LinkedIn runs only: job-detail fragments fetched after collection. Always 0 for an ATS run.
 * @param detailsTotal   LinkedIn runs only: rows queued for detail fetching. Always 0 for an ATS run.
 */
